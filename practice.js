...
const numbers = [23, 45, 32, 50, 34, 18, 19, 25];
const evenOddArr = [];
...
const chore3 = (person) =>
  `${person.firstName} ${person.lastName} did laundry.`;
const chore4 = (person) =>
  `${person.firstName} ${person.lastName} swept the house.`;
const chore5 = (person) =>
  `${person.firstName} ${person.lastName} washed the car.`;
const chore6 = (person) =>
  `${person.firstName} ${person.lastName} cooked food.`;
...
const firstchore = "mowed the grass";
const secondchore = "took out the trash";
const thirdchore = "washed the car";

const dayPlanner = (firstchore, secondchore, thirdchore, person, day) => {
  const choreString = `On ${day} ${person.firstName} ${person.lastName} ${firstchore} and ${person.firstName} ${person.lastName} ${secondchore} and ${person.firstName} ${person.lastName} ${thirdchore}.`;
  return choreString;
};

const plannerEvent = dayPlanner(firstchore, secondchore, thirdchore, person2, day);
